        ...
        <div className="fixed top-0 left-0 w-full bg-white dark:bg-gray-900 z-50 py-2 shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors">
            <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 h-12">
                ...
                <div className="flex-shrink-0 flex items-center gap-4">
                    <Link to="/" title="Home" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                        <Home size={24} />
                    </Link>
                    <Link to="/feed" title="Feed" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                        <Users size={24} />
                    </Link>
                    <Link to="/create-post" title="Create Post" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                        <PlusSquare size={24} />
                    </Link>
                    <Link to={`/profile/${currentUserId}`} title="Profile" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                         <User size={24} />
                    </Link>
                    <ThemeToggle />
                </div>
