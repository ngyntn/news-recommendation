    ...
    return (
        <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="hidden md:flex flex-col justify-center items-center bg-indigo-600 text-white p-12">
                ...
                <h1 className="text-4xl font-bold mb-2">Tham gia ngay!</h1>
                <p className="text-indigo-200 text-center">Tạo tài khoản để bắt đầu hành trình chia sẻ và học hỏi của bạn ngay hôm nay.</p>
            </div>
